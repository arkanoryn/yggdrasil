...
cp ~/ubuntu/.oh-my-zsh/templates/zshrc.zsh-template /home/ubuntu/.zshrc
...
echo "alias ,server=\"cd /projects/yggdrasil/server\"" >> /home/ubuntu/.zshrc
echo "alias ,client=\"cd /projects/yggdrasil/client\"" >> /home/ubuntu/.zshrc
echo "alias ,ygg=\"cd /projects/yggdrasil/\"" >> /home/ubuntu/.zshrc
